...
export const users = new Elysia({ prefix: '/users' })
  .get(
    '/',
    async ({ query }) => userService.findUserByEmail(query),
    {
  ...
  .get(
    '/:id',
    async ({ params }) => userService.findUserById(params),
    {
  ...
  .patch(
    '/:id',
    async ({ params, body }) => userService.updateUser(params.id, body),
    {
      params: UserModel.getByIdParams,
  ...
  .delete(
    '/:id',
    async ({ params }) => userService.deleteUser(params.id),
    {
      params: UserModel.getByIdParams,
      response: mutateUserResponse,
    },
