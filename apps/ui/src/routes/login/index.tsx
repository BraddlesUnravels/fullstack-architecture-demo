...
export default component$(() => {
  ...
  return (
    <PublicLayout colClasses="lg:grid-cols-[40%_65%] xl:grid-cols-[30%_70%]">
      <section
        id="left-wrapper"
      ...
      >
        ...
        <div
          id="outer-slide-wrap"
          class="relative z-10 grid w-full h-full overflow-hidden items-center min-h-full pl-3 pr-3"
        >
          <div
