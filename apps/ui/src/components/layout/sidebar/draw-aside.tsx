...
const asideClasses = [
  'relative flex h-[calc(100dvh-1rem)] max-w-[5.5rem] flex-col overflow-hidden',
  'rounded-[1rem] border border-white/15 bg-white/3 backdrop-blur-2xl',

  /**
   * Desktop outer spacing
   */
  'lg:m-3 lg:h-[calc(100dvh-1.5rem)] lg:w-[7.5rem] lg:items-center',

  /**
   * Inner page spacing
   */
  'px-0 py-[var(--side-pad)]',
  '[--side-pad:clamp(0.5rem,1.4dvh,1rem)]',
  '[--logo-size:clamp(2.25rem,6dvh,5rem)]',
  '[--nav-gap:clamp(0.25rem,1dvh,0.75rem)]',
  '[--nav-item:clamp(2.25rem,7dvh,5rem)]',
  '[--nav-icon:clamp(1.45rem,3dvh,2.25rem)]',
